...
# Audio
PRODUCT_COPY_FILES += \
    device/lge/bullhead/audio_effects.conf:$(TARGET_COPY_OUT_SYSTEM)/etc/audio_effects.conf \
    device/lge/bullhead/mixer_paths.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/mixer_paths.xml \
